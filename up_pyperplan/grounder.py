...
def _get_fresh_name(new_problem: 'unified_planning.model.Problem', name: str) -> str:
...
def rewrite_back_task(task: 'pyperplan.task.Task', original_problem: 'unified_planning.model.Problem') -> Tuple['unified_planning.model.Problem', Dict['unified_planning.model.Action', Tuple['unified_planning.model.Action', List['unified_planning.model.FNode']]]]:
    ...
    grounded_problem = unified_planning.model.Problem(task.name, original_problem.env)
    rewrite_back_map: Dict['unified_planning.model.Action', Tuple['unified_planning.model.Action', List['unified_planning.model.FNode']]] = {}
    #map from names in the task domain to fluents of the grounded problem
    vars_to_fluent_map: Dict[str, 'unified_planning.model.Fluent'] = {}
    for fact in task.facts:
        fluent = unified_planning.model.Fluent(_get_fresh_name(grounded_problem, _change_notation(fact)))
    ...
    for operator in task.operators:
        new_action = unified_planning.model.InstantaneousAction(_get_fresh_name(grounded_problem, _change_notation(operator.name)))
        ...
        parameters: List['unified_planning.model.Object'] = []
